...
document.querySelectorAll('.open-panel-button').forEach(function(panelButton) {
    ...
    panelButton.addEventListener("click", function() {
        ...
        target = document.querySelector('.games-panel[data-panel="' + this.getAttribute("data-panel") + '"]');
        others = document.querySelectorAll('.games-panel:not([data-panel="' + this.getAttribute("data-panel") + '"])');
    ...
    document.querySelectorAll(".close-panel").forEach(function(closeButton) {
      closeButton.addEventListener("click", function() {
        ...
        findAncestor(this, "games-panel").classList.remove("open");
      });
    });
